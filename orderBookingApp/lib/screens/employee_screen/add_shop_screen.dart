...
//   final _regionNameFocus = FocusNode();
...
//                           focusNode: _regionNameFocus,
//                           nextFocus: _ownerNameFocus,
//                           label: 'Region Name',
//                           icon: Icons.map_outlined,
//                           hint: 'Enter region name you assigned',
...
class _AddShopScreenState extends ConsumerState<AddShopScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref.read(regionofflineViewModelProvider.notifier).fetchRegions(ref.read(employeeloginViewModelProvider).companyId?? '');
    });
  }
