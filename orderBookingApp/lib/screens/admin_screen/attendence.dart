...
class _AttendanceCalendarPageState
 ...
 void _showDayDetails(DateTime date, List<CheckInStatusRequest> records) {
  showModalBottomSheet(
    ...
    isScrollControlled: true, // 👈 allows the sheet to grow beyond half screen
        ...
        child: Column(
          ...
          children: [
            ...
            if (records.isEmpty)
              ...
              Expanded(  // 👈 takes remaining space and allows scrolling
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return ListTile(
                      ...
                      leading: Icon(
                        Icons.check_circle,
                        color: r.checkinStatus == 1 ? Colors.green : Colors.orange,
                      ),
                    );
                  },
                ),
